  ...
  return (
    <>
      ...
      <p>
        ...
        FareFlanker, the owner and provider of this Website…
      </p>
...
const DefinitionsSection = () => {
  return (
    <div>
      ...
      <h4>Data</h4>
      <p>
        Collectively all information that you submit to FareFlanker via the
...
const ScopeSection = () => {
  return (
    <div>
      ...
      <p>
        This privacy policy applies only to the actions of FareFlanker and
