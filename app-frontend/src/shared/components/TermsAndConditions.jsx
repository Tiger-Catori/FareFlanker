  ...
  return (
    <div>
      ...
      <p>
        ...
        FareFlanker does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of FareFlanker, its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, FareFlanker
      ...
      <p>
        FareFlanker reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant FareFlanker a non-exclusive license to use,
  ...
  return (
    <div>
      ...
      <p>
        ...
        of organisations: commonly-known consumer and/or business information
      ...
      <ul>
        ...
        <li>
          ...
          the absence of FareFlanker; and
        </li>
      ...
      <ul>
        ...
        <li>
          (b) does not falsely imply sponsorship, endorsement or approval of the
          linking party’s products or services;
        </li>
        <li>(c) fits within the context of the linking party’s site.</li>
      </ul>
      <p>
        ...
        e-mail to FareFlanker. Please include your name, your organisation
      ...
      <p>
        No use of FareFlanker’s logo or other artwork will be allowed for
...
const ReservationOfRightsSection = () => {
  return (
    <div>
